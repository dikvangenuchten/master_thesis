...
class DDIMNoiseScheduler(object):
    ...
    def compute_loss_weights(self, mode="max_clamp_snr", max_snr=5.0):
        ...
        if mode == "inverse_log_snr":
            self.weights = torch.log(1.0 / snr).clamp(min=1)
    ...
    def get_betas_for_alpha_bar(
        self, num_diffusion_timesteps, max_beta=0.999
    ) -> torch.Tensor:
        """
    ...
    def add_noise(
        ...
        noisy_samples = (
            sqrt_alpha_prod * scale * original_samples
    ...
    def remove_noise(
        ...
        original_samples = (noisy_samples - sqrt_one_minus_alpha_prod * noise) / (
            sqrt_alpha_prod * scale
        )
    ...
    def step(
        ...
        return DDIMNoiseSchedulerOutput(
    ...
    def __str__(self) -> str:
        ...
        return (
            f"DDIMScheduler(num_inference_steps={self.num_inference_steps}, "
