...
try:
    ...
    logging.error("Could not import fiftyone, please install using `pip install fiftyone`")
    raise e from None
...
def main(name: str, split: Literal["train", "validation"]="validation", max_samples: Optional[int]=None, classes: List[str]=["Cat", "Dog"]):
